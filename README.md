...
起動するとトップ画面が表示されます。
トップ画面は、放送局表示部、ディレクトリ表示部、保存番組表示部から構成されます。
